...
module EnjuRoot
  RSpec.describe ThemasController, type: :controller do
    ...
    describe "GET #index" do
      it "assigns all themas as @themas" do
        ...
        expect(assigns(:themas)).to eq([thema])
      end
    end
    ...
    describe "GET #show" do
      it "assigns the requested thema as @thema" do
        ...
        expect(assigns(:thema)).to eq(thema)
      end
    end
    ...
    describe "GET #new" do
      it "assigns a new thema as @thema" do
        ...
        expect(assigns(:thema)).to be_a_new(Thema)
      end
    end
    ...
    describe "POST #create" do
      context "with valid params" do
        ...
        it "assigns a newly created thema as @thema" do
          post :create, {:thema => valid_attributes}, valid_session
          expect(assigns(:thema)).to be_a(Thema)
          expect(assigns(:thema)).to be_persisted
        end

        it "redirects to the created thema" do
          post :create, {:thema => valid_attributes}, valid_session
          expect(response).to redirect_to(Thema.last)
        end
      end

      context "with invalid params" do
        it "assigns a newly created but unsaved thema as @thema" do
          post :create, {:thema => invalid_attributes}, valid_session
          expect(assigns(:thema)).to be_a_new(Thema)
        end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested thema" do
          thema = Thema.create! valid_attributes
          put :update, {:id => thema.to_param, :thema => new_attributes}, valid_session
          thema.reload
        ...
        it "redirects to the thema" do
          thema = Thema.create! valid_attributes
          put :update, {:id => thema.to_param, :thema => valid_attributes}, valid_session
          expect(response).to redirect_to(thema)
        end
      end
      ...
      context "with invalid params" do
        it "assigns the thema as @thema" do
          thema = Thema.create! valid_attributes
          put :update, {:id => thema.to_param, :thema => invalid_attributes}, valid_session
          expect(assigns(:thema)).to eq(thema)
        end
    ...
    describe "DELETE #destroy" do
      ...
      it "redirects to the themas list" do
        thema = Thema.create! valid_attributes
        delete :destroy, {:id => thema.to_param}, valid_session
        expect(response).to redirect_to(themas_url)
      end
    end
